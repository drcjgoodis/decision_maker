...
def math_q():
    ...
    if math.isclose(math_result_guess_float,       math_result_rounded, rel_tol = 0.001):
        ...
        math_result_guess_str = input('Again, for security purposes, please input the correct answer given to continue: \n')
        math_result_guess_float = float(math_result_guess_str)
...
print('Then the points are accumulated and you will be assigned your earliest priority date to register and choose your housing. \n')
...
credit_hrs_int, credit_hrs_str = confirm_digit('Please enter how many credit hours you will have before the beginning of the fall semester. This will include credits taken here at Rollins, credits you are transferring in, or all AP exam credits for scores 4 or 5: \n', valid_credit_hours, 
...
class_standing_int, class_standing_str =confirm_digit('What is your class standing? Put 1 for Freshman, 2 for Sophomore, 3 for Junior, 4 for Senior: \n', valid_class_standing, 
